...
public class UIClient extends JFrame {
    ...
    public UIClient(int _id) {
        ...
        try {
            ...
            setTitle("Client NO : " + bilgiler.get(0));
            setSize(350, 410);
            setLocationRelativeTo(null);
            setVisible(true);
    ...
    private void initComponents() {
       ///setType(Type.POPUP);
        ...
        lblBaslik.setText("CLIENT ADD");
        if (id != 0) {
            lblBaslik.setText("CLIENT UPDATE");
        }
        ...
        btnEkle.setText("Client Add");

        if (id != 0) {
            btnEkle.setText("Client Update");
        }
