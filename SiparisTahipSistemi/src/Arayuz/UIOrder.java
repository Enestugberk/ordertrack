...
public class UIOrder extends javax.swing.JFrame {
    ...
    public UIOrder() {
        ...
        try {
            ...
            Logger.getLogger(UIOrder.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public UIOrder(int _id) throws SQLException {
        id = _id;
        initComponents();
        Listele();
        try {
            ...
            if (bilgiler.get(6).equals("Order Confirmed")) {
                cbDurum.setSelectedIndex(1);
            }
            setTitle("Order NO : " + bilgiler.get(0));
            setSize(300, 350);
            setLocationRelativeTo(null);
            setVisible(true);
        } catch (SQLException ex) {
    ...
    private void initComponents() {
        ...
        if (id == 0) {
            lbBaslik.setText("ORDER ADD");
        } else {
            lbBaslik.setText("ORDER UPDATE");
        }
        ...
        if (id == 0) {
            btnEkle.setText("Order Add");
        } else {
            btnEkle.setText("Order Update");
        }
