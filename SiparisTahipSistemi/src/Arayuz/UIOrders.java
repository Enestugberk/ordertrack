...
public class UIOrders extends javax.swing.JFrame {
    ...
    public UIOrders() {
        ...
        try {
            ...
            Logger.getLogger(UIOrders.class.getName()).log(Level.SEVERE, null, ex);
        }
        ;
    }
    ...
    private void initComponents() {
        ...
        tablo.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][]{},
                new String[]{
                    "ID", "Client ID", "Product ID", "Part", "Total", "Date", "Status"
                }
        ) {
        ...
        btnSiparisEkle.setText("Product Add");
        ...
        btnMusteriEkle.setText("Client Add");
    ...
    private void btnUrunEkleActionPerformed(java.awt.event.ActionEvent evt) {
        UIProduct aRUrun = new UIProduct();
    }
    ...
    private void btnGuncelleActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        UIOrder arSiparis = new UIOrder(id);
    }
